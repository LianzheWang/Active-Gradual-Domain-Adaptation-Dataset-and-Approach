...
def param_lr(model, args):
    ...
    """
    lr_groups = []
    lr_groups.extend([(model.base_model.conv1.parameters(), features_lr),
                      (model.base_model.bn1.parameters(), features_lr),
                      (model.base_model.layer1.parameters(), features_lr),
                      (model.base_model.layer2.parameters(), features_lr),
                      (model.base_model.layer3.parameters(), features_lr),
                      (model.base_model.layer4.parameters(), features_lr),
                      (model.base_model.fc.parameters(), classifier_lr)])
    return lr_groups
...
def getOptim(model, args):
    ...
    optimizer = torch.optim.Adam(model.parameters(),lr=features_lr)
    return optimizer


def base_resnet(num_classes, res = resnet18):
    model = res(pretrained=False)
...
class Model(nn.Module):
    def __init__(self, num_classes):
        ...
        self.parameter = list(self.output.parameters())
